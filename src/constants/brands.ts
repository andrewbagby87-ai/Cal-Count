...
export const FOOD_BRANDS: BrandConfig[] = [
    ...
    { name: "Bilinski's", logo: './brands/bilinskis.png' },
    { name: "Candy Dates", logo: './brands/candydates.png' },
    { name: "CHEEZ IT", logo: './brands/cheezit.png' },
    { name: "Day Out", logo: './brands/dayout.png' },
    { name: "Delimex", logo: './brands/delimex.png' },
    { name: "Drizzilicious", logo: './brands/drizzilicious.png' },
